...
public class ShowData {
    ...
    static final String url = "jdbc:mysql://localhost:3306/barang";  // ganti mahasiswa menjadi barang
    ...
    public static void main(String[] args) {
        try {
            ...
            String sql = "SELECT * FROM barang";  // ganti mahasiswa menjadi barang
            ...
            while (rs.next()) {
                ...
                System.out.println("STOK BARANG: " + rs.getString("stok_barang"));
                System.out.println("====================================");
            }
